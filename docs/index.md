...
- ### Adhesión de la IDE-FCyT a IDERA
  ![Adhesión IDE-FCyT a IDERA](images/adhesion_idera.jpg)

  Incorporación de la IDE-FCyT a la red académica nacional, fortaleciendo interoperabilidad y colaboración federal.

  **Fecha:** 10 de octubre de 2025  
  [Leer nota](https://mailchi.mp/9cbd10081684/boletn-informativo-ideractiva-mes-10){ .quick-link }

- ### Nueva versión del COG de IDERA
  ![Catálogo de Objetos Geográficos de IDERA](images/catalogo_objetos.jpg)

  Actualización del catálogo de objetos geográficos con nuevas clases, subclases y mejoras para navegación semántica.
...
La IDE FCyT se complementa con la Infraestructura de Datos Espaciales de la República Argentina (IDERA) y con iniciativas académicas de la región para fortalecer la interoperabilidad y la colaboración.

- [IDERA](https://www.idera.gob.ar/)
- [Repositorio IDE-FCyT en GitHub](https://github.com/IDE-FCyT/IDE-FCyT)
